...
- TOKENMAXX actionlint path-filter residual leftover deepen after #320 tip
  (lands closed #323/#319/#317 leftover on post-#320 tip): expand self-tests to
  7000 cases (was 6854) fail-closing DISTINCT unsaturated residual leftover
  path-filter CI edges on existing workflow modules only — exact contiguous
  ...
  residual leftover slice only (not saturated leftover #314 / not path-order
  residual leftover #323 / not schema residual CI leftover residual #320 /
  ...
  #323/#319/#317 leftover on post-#320 tip (do **not** revive closed PRs
