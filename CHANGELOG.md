...
- TOKENMAXX actionlint path-filter/path-order residual deepen leftovers after
  #233 tip: expand self-tests to 4562 cases (was 4414) fail-closing DISTINCT
  residual actionlint path-filter / path-order edges on existing workflow
  modules — contiguous pull_request:/schedule: adjacency (bare PR) / reject
  ...
  stewardship-checks/schema #233 / not stewardship-badge lint #208); no
  invent-product; no fourth badge. Lands closed #232 leftover on post-#233
  tip (do **not** revive #232/#234/#235/#228/#226/#223). Distinct from merged
  #233/#227/#225/#220/#216/#208/#203/#199/#191/#189.
