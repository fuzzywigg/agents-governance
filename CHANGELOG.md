...
- TOKENMAXX stewardship-schema residual CI leftover residual deepen after #309 tip:
  expand self-tests to 6700 cases (was 6464) fail-closing unsaturated schema-only
  residual CI leftover residual helper needles on existing `check_stewardship_schema.py` —
  ...
  #272 / not path-filter/path-order leftover #262 / not schema leftover #258 / not
  wiki/mdlink leftover #252 / not path-edges residual #244 / not
  ...
  Tip-relaunch residual CI leftover residual on post-#309 tip (do **not** revive
