...
- TOKENMAXX stewardship-schema gate pins after #46: expand self-tests to 1116
  cases (was 1045) fail-closing live schema integrity — `STRING_KEYS` /
  ...
  schema gate scalar / live-pin slice only (not wiki-outline /
