...
- TOKENMAXX actionlint path-order residual leftover deepen after #320 tip
  (lands closed #332/#330/#323/#319/#317 leftover on post-#337 tip): expand
  self-tests to 7460 cases (was 7302) fail-closing DISTINCT unsaturated
  ...
  slice only (not Pass-2 residual templates leftover #337 / not wiki/mdlink
  leftover #326 / not schema residual CI leftover residual #320 / not
  saturated leftover #314 / not schema residual CI leftover #309 / not schema
  residual CI #299 / not wiki/mdlink leftover residual #293 / not
  ...
  post-#337 tip (do **not** revive closed PRs
