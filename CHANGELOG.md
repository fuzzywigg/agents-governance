...
- TOKENMAXX markdown-lint/link-check CI workflow edges after #203: expand
  self-tests to 3724 cases (was 3660) fail-closing unsaturated md/link edges —
  ...
  (not Pass-2 register #203 / Pass-2 residual #199 / schema third-pass #191 /
  path-order #189 / Pass-2 core #179 / wiki-index #181 / path-filter #176 /
  badge-lint spam); no invent AGENTS-ECOSYSTEM / templates / secrets.
