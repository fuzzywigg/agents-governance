...
- TOKENMAXX leftover docs-lint/stewardship/actionlint pins after #141: expand
  self-tests to 2813 cases (was 2689) fail-closing live leftover integrity —
  ...
  full layout — leftover docs-lint/stewardship/actionlint slice only (not wiki /
  badge / CI workflow / relative / schema spam); no invent-product; no fourth
  badge. Distinct from docs-lint second-pass (#135), wiki-badge (#141), and
  closed #146 (do not revive).
