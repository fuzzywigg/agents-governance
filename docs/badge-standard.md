...
plus stewardship-schema leftover residual deepen after #262 tip: leftover
...
DISTINCT leftover residual only (not path-filter/path-order leftover #262 /
...
leftover #227; do not revive closed #263/#257/#253/#248/#241)).
