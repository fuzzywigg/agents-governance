...
plus stewardship-badge lint deepen after #161: README invent stewardship-checks workflow badge refuse / exact link-check+markdown-lint
`badge.svg` paths / exact live markdown-lint globs block + push paths /
exact live link-check push paths / missing badge fixtures (NOT docs-lint
leftover #161 / NOT wiki-badge #141).
