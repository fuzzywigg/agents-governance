...
plus Pass-2 residual / templates leftovers after #297 tip: soft-fail with
...
keep Same-repo GitHub — DISTINCT leftover only (lands closed #298/#291 leftover
on post-#297 tip; not stewardship-schema residual CI #297 /
...
templates; no secrets; do not revive #298/#291)).
