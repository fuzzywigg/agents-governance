...
plus docs-lint third-pass after #149: exact live `.lycheeignore` full layout +
exact commentary lines / stewardship leftover exact live
`run_stewardship_checks.sh` full layout).
