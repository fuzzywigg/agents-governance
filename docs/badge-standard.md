...
plus actionlint path-filter/path-order residual leftover deepen after #299 tip
(lands closed #303/#304/#300/#294/#292/#286/#280 leftover):
...
path-order — DISTINCT residual leftover edges only (not schema residual CI #299 /
