...
plus stewardship-schema leftover residual deepen after #272 tip:
leftover residual parse/load needles / leftover residual invalid
status+surface stubs / `stewardship_common`
errors.append+lowered+scheme+found.update leftovers — DISTINCT leftover
residual only (not Pass-2 residual leftover #272 / not
path-filter/path-order leftover #262 / not schema leftover #258 / not
wiki/mdlink leftover #252 / not path-edges residual #244 / not wiki
