...
(rebased post-#272): leftover residual parse/load needles / leftover residual
invalid status+surface stubs / `stewardship_common`
errors.append+lowered+scheme+found.update leftovers — DISTINCT leftover
residual only (not Pass-2 residual leftover #272 / not path-filter/path-order
...
PR #276/#275/#269/#263/#257/#253/#248/#241; prior #269 RED was MD018)).
