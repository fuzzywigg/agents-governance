...
(rebased post-#258): soft-fail with `|| :` / `|| return 0` / `set +o errexit` /
...
only (not stewardship-schema leftover #258 / not wiki/mdlink leftover #252 / not actionlint path-filter/path-order
