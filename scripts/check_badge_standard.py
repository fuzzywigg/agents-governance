...
- schema residual deepen after #326: residual helper needles + residual status/surface stubs (schema residual slice)
  (NOT wiki/mdlink leftover residual #326 / NOT schema residual CI leftover residual #320 / NOT schema residual CI leftover #309 / NOT schema residual CI #299 / NOT wiki/mdlink leftover residual #293 / NOT schema leftover residual #282 / NOT lychee/blob-503 leftover #278 / NOT Pass-2 residual leftover #272 / NOT path-filter/path-order leftover #262 / NOT schema leftover #258 / NOT wiki/mdlink leftover #252 / NOT path-edges residual #244 / NOT schema residual (pass-5) #233)
...
def check_stewardship_common_contract(errors: list[str]) -> None:
    """Fail-close live stewardship_common wiring (after #111; deepen after #65/#46; leftover after #252; leftover residual after #262; residual CI deepen after #293; residual CI leftover deepen after #299; residual CI leftover residual deepen after #309; residual deepen after #326)."""
...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    """Fail-close live stewardship-schema gate wiring (after #72/#75; third-pass after #132; deepen after #189; policy-schema pass-4 after #208; schema residual after #225; leftover after #252; leftover residual after #262; residual CI deepen after #293; residual CI leftover deepen after #299; residual CI leftover residual deepen after #309; residual deepen after #326)."""
    ...
    # Fail-closed after #326: schema residual helper / constant / needle pins
    # (schema residual slice only; not wiki/mdlink leftover residual #326 /
    ...
    not_wiki_mdlink_leftover_residual_326 = "NOT wiki/mdlink leftover residual " + "#326"
    if not_wiki_mdlink_leftover_residual_326 not in text:
        fail(
            "check_stewardship_schema.py docstring must pin " + not_wiki_mdlink_leftover_residual_326,
            errors,
        )
