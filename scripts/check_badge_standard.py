...
Fail-closed actionlint path-filter/path-order residual deepen after #233
...
md/link #220 / NOT wiki-badge leftover #227 / NOT schema residual #233 /
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    Path-filter/path-order residual deepen after #233 (NOT saturated deepen
    #225/#203 / NOT #189 / NOT #176 / NOT schema #191/#216 /
    NOT Pass-2 residual #199/#203 / NOT Pass-2 leftover + md/link #220 /
    NOT wiki-badge leftover #227 / NOT schema residual #233 /
    NOT stewardship-badge lint #208):
    ...
    # Path-filter/path-order residual deepen after #233 (DISTINCT leftover edges;
    # NOT saturated deepen #225/#203 / NOT #189 path-order / NOT #176 layouts /
    # NOT schema #191/#216 / NOT Pass-2 residual #199/#203 /
    # NOT Pass-2 leftover + md/link #220 / NOT wiki-badge leftover #227 /
    # NOT schema residual #233 / NOT stewardship-badge lint #208).
...
def check_workflow_hardening_gate_contract(errors: list[str]) -> None:
    ...
    # Path-filter/path-order residual deepen after #233 (DISTINCT leftover edges).
    path_residual_233_doc = "Path-filter/path-order residual deepen after " + "#233"
    if path_residual_233_doc not in text:
        fail(
            "check_workflow_hardening docstring must pin " + path_residual_233_doc,
            errors,
        )
    module_path_residual_233 = "path-filter/path-order residual deepen after " + "#233"
    if module_path_residual_233 not in text:
        fail(
            "check_badge_standard.py module docstring must pin "
            + module_path_residual_233,
            errors,
        )
    ...
    not_176_path_residual = "NOT " + "#176"
    if not_176_path_residual not in text:
        fail(
            "path residual must keep " + not_176_path_residual + " distinctness pin",
            errors,
        )
    ...
    not_pass2_mdlink_220 = "NOT Pass-2 leftover + " + "md/link #220"
    if not_pass2_mdlink_220 not in text:
        fail(
            "path residual must keep " + not_pass2_mdlink_220 + " distinctness pin",
            errors,
        )
    not_wiki_227 = "NOT wiki-badge leftover " + "#227"
    if not_wiki_227 not in text:
        fail(
            "path residual must keep " + not_wiki_227 + " distinctness pin",
            errors,
        )
    not_schema_residual_233 = "NOT schema residual " + "#233"
    if not_schema_residual_233 not in text:
        fail(
            "path residual must keep " + not_schema_residual_233 + " distinctness pin",
            errors,
        )
    not_badge_lint_208 = "NOT stewardship-badge lint " + "#208"
    if not_badge_lint_208 not in text:
        fail(
            "path residual must keep " + not_badge_lint_208 + " distinctness pin",
            errors,
        )
    path_residual_233_pins = (
        (
    ...
    for needle, label in path_residual_233_pins:
        if needle not in text:
            fail(
                "check_workflow_hardening must keep " + label,
                errors,
