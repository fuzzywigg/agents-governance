...
after_320 pins; NOT wiki/mdlink leftover residual after #320 /
...
def check_relative_link_gate_contract(errors: list[str]) -> None:
    ...
    leftover_326_rel = "Wiki/mdlink leftover residual after " + "#326"
    if leftover_326_rel not in text:
        fail(
            "check_relative_links.py docstring must keep " + leftover_326_rel + " pin",
            errors,
        )
