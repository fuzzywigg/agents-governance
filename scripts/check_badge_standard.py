...
- schema residual deepen after #320: residual helper needles + residual status/surface stubs (schema residual slice)
...
def check_stewardship_common_contract(errors: list[str]) -> None:
    """Fail-close live stewardship_common wiring (after #111; deepen after #65/#46; leftover after #252; leftover residual after #262; residual CI deepen after #293; residual CI leftover deepen after #299; residual CI leftover residual deepen after #309; residual deepen after #320)."""
...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    """Fail-close live stewardship-schema gate wiring (after #72/#75; third-pass after #132; deepen after #189; policy-schema pass-4 after #208; schema residual after #225; leftover after #252; leftover residual after #262; residual CI deepen after #293; residual CI leftover deepen after #299; residual CI leftover residual deepen after #309; residual deepen after #320)."""
    ...
    # Fail-closed after #320: schema residual helper / constant / needle pins
    # (schema residual slice only; not schema residual CI leftover residual #320 /
    ...
    # not schema residual (pass-5) #233 spam).
    # Split literals so self-mutation of contiguous names cannot neutralize checks.
    residual_320_doc = "Residual deepen after " + "#320 (schema residual"
    if residual_320_doc not in text:
        fail(
            "check_stewardship_schema.py docstring must pin " + residual_320_doc,
            errors,
        )
    ...
    residual_320_host = "schema residual deepen after " + "#320"
    self_text10 = BADGE_GATE.read_text(encoding="utf-8")
    if residual_320_host not in self_text10:
        fail(
            "check_badge_standard.py must keep " + residual_320_host + " host pin",
            errors,
        )
    residual_320_slice = "schema residual " + "slice"
    if residual_320_slice not in self_text10:
        fail(
            "check_badge_standard.py schema residual must keep "
            + residual_320_slice
            + " pin",
    ...
    contract_residual_320 = "residual deepen after " + "#320"
    if contract_residual_320 not in self_text10:
        fail(
            "check_stewardship_schema_gate_contract docstring must pin "
            + contract_residual_320,
            errors,
        )
