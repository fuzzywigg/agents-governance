...
def check_readme_consistency(text: str, errors: list[str]) -> None:
    ...
    # Deepen after #189: wiki-index/badge leftover — refuse invent fourth-badge
    # workflow SVG (lands closed #172 stewardship-badge lint leftover; NOT
    # path-order #189 / NOT stewardship-schema sibling).
