...
validation after #233 (NOT wiki outline/PUBLISH leftover #243 / NOT md/link residual #239 / NOT stewardship-checks/schema residual #233 /
...
NOT path-order #189; lands closed #240/#235/#230 leftover on post-#243 tip;
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    Pass-2 residual + existing templates/AGENTS-REPO.md leftover after #243
    (NOT wiki outline/PUBLISH leftover #243 / NOT md/link residual #239 / NOT stewardship-checks/schema residual #233 / NOT wiki-index/badge #227 /
    NOT path-edges #225 / NOT Pass-2 leftover+md/link #220 / NOT Pass-2 residual #199/#203 /
    NOT badge-lint #208 / NOT schema #216; do not invent new templates):
    ...
    for name in REQUIRED_WORKFLOWS:
        ...
        # Exact contiguous concurrency group template leftover after #243
        ...
        if exact_concurrency not in text:
            fail(
                ...
                "(Pass-2 residual / template validation leftover after #243)",
                errors,
            )
...
def check_agents_repo_template(errors: list[str]) -> None:
    """Fail-close existing templates/AGENTS-REPO.md leftover after #243.
...
def check_relative_link_gate_contract(errors: list[str]) -> None:
    ...
    if not RUN_STEWARDSHIP.is_file():
        ...
        # Pass-2 residual leftover after #243 (soft-fail leftovers beyond
...
def check_run_stewardship_gate_contract(errors: list[str]) -> None:
    ...
    leftover_243 = "Pass-2 residual / template validation leftover after " + "#243"
    if leftover_243 not in text:
        fail(
            "run_stewardship pins must keep " + leftover_243 + " marker",
            errors,
        )
