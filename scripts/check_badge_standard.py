...
(NOT schema residual CI leftover #309 / NOT schema residual CI #297 / NOT wiki/mdlink leftover residual #293 / NOT stewardship-schema residual #282 /
NOT lychee/blob-503 harden #278 /
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    Path-filter/path-order residual leftover deepen after #272 (NOT schema residual CI leftover #309 / NOT schema residual CI #297 / NOT wiki/mdlink
    leftover residual #293 / NOT stewardship-schema residual #282 /
...
def check_workflow_hardening_gate_contract(errors: list[str]) -> None:
    ...
    not_schema_ci_leftover_309 = "NOT schema residual CI leftover " + "#309"
    if not_schema_ci_leftover_309 not in text:
        fail(
            "path leftover-after-272 must keep "
            + not_schema_ci_leftover_309
            + " distinctness pin",
            errors,
        )
    not_schema_ci_297 = "NOT schema residual CI " + "#297"
    if not_schema_ci_297 not in text:
        fail(
            "path leftover-after-272 must keep "
            + not_schema_ci_297
            + " distinctness pin",
