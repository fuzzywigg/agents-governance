...
- schema leftover residual after #272: leftover residual helper needles + leftover residual status/surface stubs (schema leftover residual slice)
  (NOT Pass-2 residual leftover #272 / NOT schema leftover #258 / NOT wiki/mdlink leftover #252 / NOT path-edges residual #244 / NOT wiki outline/PUBLISH #243 / NOT md/link residual #239 / NOT schema residual (pass-5) #233)
...
def check_stewardship_common_contract(errors: list[str]) -> None:
    ...
    # (common leftover residual slice only; not Pass-2 residual leftover #272 /
    ...
    # Split literals so self-mutation of contiguous names cannot neutralize checks.
    common_leftover_262_doc = "Residual leftover after " + "#272 (common leftover residual"
    ...
    common_host_262 = "common leftover residual after " + "#272"
...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    ...
    # (schema leftover residual slice only; not Pass-2 residual leftover #272 /
    # not schema leftover #258 / not wiki/mdlink leftover #252 /
    # not path-edges residual #244 / not wiki outline/PUBLISH #243 / not md/link residual #239 /
    # not schema residual (pass-5) #233 spam).
    # Split literals so self-mutation of contiguous names cannot neutralize checks.
    leftover_262_doc = "Residual leftover after " + "#272 (schema leftover residual"
    if leftover_262_doc not in text:
        fail(
            "check_stewardship_schema.py docstring must pin " + leftover_262_doc,
            errors,
        )
    not_path_leftover_262 = "NOT Pass-2 residual leftover " + "#272"
    if not_path_leftover_262 not in text:
        fail(
            "check_stewardship_schema.py docstring must pin " + not_path_leftover_262,
            errors,
        )
    not_path_edges_262 = "NOT path-filter/path-order leftover " + "#262"
    if not_path_edges_262 not in text:
        fail(
            "check_stewardship_schema.py docstring must pin " + not_path_edges_262,
            errors,
        )
    ...
    leftover_host_262 = "schema leftover residual after " + "#272"
