...
after_293 pins; lands #308/#307/#311/#302 leftover; NOT stewardship-schema residual CI leftover #309 / NOT stewardship-schema residual CI #299 /
...
# Fail-closed after #227: markdown-lint/link-check residual exact layouts
    ...
    # Wiki/mdlink leftover residual after #309 tip: md/link residual harden beyond #293 (lands #308/#307/#311/#302).
    link_token_args_adj = (
        "          token: ${{ secrets.GITHUB_TOKEN }}\n"
        "          args: >-"
    )
