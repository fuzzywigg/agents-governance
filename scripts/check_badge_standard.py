...
Fail-closed actionlint path-filter residual leftover deepen after #314
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    contiguous six-step actionlint path-order.
    Path-filter residual leftover deepen after #314 (NOT saturated leftover
    #314 / NOT path-order residual leftover #323 /
    NOT schema residual CI leftover residual #320 / NOT schema residual CI leftover #309 /
    NOT schema residual CI #299 / NOT wiki/mdlink leftover residual #293 /
    NOT stewardship-schema residual #282 /
    NOT lychee/blob-503 harden #278 / NOT Pass-2 residual leftover #272 /
    ...
    # Path-filter residual leftover deepen after #314 (DISTINCT leftover;
    # NOT saturated leftover #314 / NOT path-order residual leftover #323 /
    # NOT schema residual CI leftover residual #320 / NOT schema residual CI leftover #309 /
    # NOT schema residual CI #299 / NOT wiki/mdlink leftover residual #293 /
    # NOT stewardship-schema residual #282 /
...
def check_workflow_hardening_gate_contract(errors: list[str]) -> None:
    ...
    not_path_order_323 = "NOT path-order residual leftover " + "#323"
    if not_path_order_323 not in text:
        fail(
            "path leftover-after-314 must keep "
            + not_path_order_323
            + " distinctness pin",
