...
Fail-closed actionlint-style pins (live path after #75; second-pass after #83/#86; third-pass after #108; deepen after #132):
...
- Deepen after #132: cancel-in-progress: true / contents: read /
...
def check_actionlint_style(errors: list[str]) -> None:
    ...
    for name in REQUIRED_WORKFLOWS:
        ...
        # Deepen after #132: CI reliability leftovers (actionlint-style slice).
...
def check_actionlint_style_gate_contract(errors: list[str]) -> None:
    ...
    # Fail-closed after #132: deepen helper / constant / needle pins
