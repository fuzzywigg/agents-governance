...
Fail-closed Pass-2 residual / templates leftover after #314 tip
...
lands closed #315/#313/#312/#305/#298/#291 leftover on post-#314 tip — do not revive #315/#313/#312/#305/#298/#291):
...
def check_lycheeignore(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #314 tip (existing lychee
    ...
    if "tree/main" in text:
        fail(
            ...
            "(Pass-2 residual / templates leftover after #314 tip; "
...
def check_agents_repo_template(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #314 tip (existing
    ...
    for needle, label in leftover_314_required:
        if needle not in text:
            fail(
                f"templates/AGENTS-REPO.md must keep {label} "
                "(Pass-2 residual / templates leftover after #314 tip)",
...
def check_relative_link_gate_contract(errors: list[str]) -> None:
    ...
    if not RUN_STEWARDSHIP.is_file():
        ...
        # Pass-2 residual / templates leftover after #314 tip (soft-fail
...
def check_run_stewardship_gate_contract(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #314 tip contract pins.
    leftover_314 = (
        "Pass-2 residual / templates leftover after " + "#314 tip"
    )
    if leftover_314 not in text:
        fail(
            "run_stewardship pins must keep " + leftover_314 + " marker",
            errors,
        )
