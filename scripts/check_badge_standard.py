...
Fail-closed Pass-2 residual / templates leftover after #320 tip
...
lands closed #324/#315/#313/#312/#305/#298/#291 leftover on post-#320 tip — do not revive #324/#315/#313/#312/#305/#298/#291):
...
def check_lycheeignore(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #320 tip (existing lychee
    # module only; NOT saturated lychee/blob-503 leftover #278 /
    # NOT saturated Pass-2 residual leftover #272 /
    # NOT wiki/mdlink leftover residual #293 /
    # NOT path-filter/path-order residual leftover #314 /
    # NOT stewardship-schema residual CI leftover residual #320 /
    # NOT stewardship-schema residual CI leftover #309 / NOT stewardship-schema residual CI #299 / do not invent templates).
    if "tree/main" in text:
        fail(
            ".lycheeignore must not invent tree/main exclude "
            "(Pass-2 residual / templates leftover after #320 tip; "
...
def check_agents_repo_template(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #320 tip (existing
    # templates/AGENTS-REPO.md only; NOT saturated leftover #272 /
    # NOT lychee/blob-503 #278 / NOT wiki/mdlink leftover residual #293 /
    # NOT path-filter/path-order residual leftover #314 /
    # NOT stewardship-schema residual CI leftover residual #320 /
    # NOT stewardship-schema residual CI leftover #309 / # NOT stewardship-schema residual CI #299; do not invent).
    leftover_320_required = (
    ...
    for needle, label in leftover_320_required:
        if needle not in text:
            fail(
                f"templates/AGENTS-REPO.md must keep {label} "
                "(Pass-2 residual / templates leftover after #320 tip)",
...
def check_relative_link_gate_contract(errors: list[str]) -> None:
    ...
    if not RUN_STEWARDSHIP.is_file():
        ...
        # Pass-2 residual / templates leftover after #320 tip (soft-fail
        # leftovers beyond saturated #272 || : / || return 0 / set +o * /
        # NOT lychee/blob-503 leftover #278 / NOT wiki/mdlink leftover residual #293 /
        # NOT path-filter/path-order residual leftover #314 /
        # NOT stewardship-schema residual CI leftover residual #320 /
        # NOT stewardship-schema residual CI leftover #309 / # NOT stewardship-schema residual CI #299).
        if "|| true" in run_text or "||true" in run_text:
            fail(
                "run_stewardship_checks.sh must not soft-fail with || true "
                "(Pass-2 residual / templates leftover after #320 tip)",
...
def check_run_stewardship_gate_contract(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #320 tip contract pins.
    leftover_320 = (
        "Pass-2 residual / templates leftover after " + "#320 tip"
    )
    if leftover_320 not in text:
        fail(
            "run_stewardship pins must keep " + leftover_320 + " marker",
            errors,
        )
