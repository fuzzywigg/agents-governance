...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    """Fail-close live stewardship-schema gate wiring (after #72/#75; third-pass after #132; deepen after #189; policy-schema pass-4 after #203)."""
    ...
    # Fail-closed after #203: policy-schema pass-4 helper / constant / needle pins
    ...
    pass4_doc = "Four" + "th-pass after #203"
    ...
    contract_pass4 = "policy-schema pass-4 after " + "#203"
