...
Fail-closed wiki/mdlink leftover residual after #293 tip (beyond #282/#293 saturated
after_282 pins; NOT wiki/mdlink leftover residual #293 /
...
# Fail-closed after #227: markdown-lint/link-check residual exact layouts
    ...
    # Wiki/mdlink leftover residual after #293 tip: md/link residual harden beyond #282/#293.
    link_token_args_adj = (
        "          token: ${{ secrets.GITHUB_TOKEN }}\n"
        "          args: >-"
    )
