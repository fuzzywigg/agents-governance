...
Fail-closed actionlint path-filter/path-order residual leftover deepen after #299
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    Path-filter/path-order residual leftover deepen after #299 (NOT schema residual CI
    #299 / NOT wiki/mdlink leftover residual #293 / NOT stewardship-schema residual #282 /
    NOT lychee/blob-503 harden #278 / NOT Pass-2 residual leftover #272 /
    NOT saturated leftover #262 /
    NOT stewardship-schema leftover #258 /
    NOT wiki/mdlink leftover #252 / NOT saturated residual #244 /
    ...
    # Path-filter/path-order residual leftover deepen after #299 (DISTINCT leftover;
    # NOT schema residual CI #299 / NOT wiki/mdlink leftover residual #293 /
    # NOT stewardship-schema residual #282 /
    # NOT lychee/blob-503 harden #278 / NOT Pass-2 residual leftover #272 /
    # NOT saturated leftover #262 /
    ...
    for wf_name, body in (
        ...
        if dispatch_concurrency not in body:
            fail(
                ...
                "adjacency "
                "(path-filter/path-order residual leftover deepen after #299)",
                errors,
            )
...
def check_workflow_hardening_gate_contract(errors: list[str]) -> None:
    ...
    # Path-filter/path-order residual leftover deepen after #299 (DISTINCT leftover).
    path_leftover_299_doc = (
        "Path-filter/path-order residual leftover deepen after " + "#299"
    )
    if path_leftover_299_doc not in text:
        fail(
            "check_workflow_hardening docstring must pin " + path_leftover_299_doc,
            errors,
        )
    path_module_leftover_299 = (
        "path-filter/path-order residual leftover deepen after " + "#299"
    )
    if path_module_leftover_299 not in text:
        fail(
            "check_badge_standard.py module docstring must pin "
            + path_module_leftover_299,
            errors,
    ...
    if not_schema_residual_ci_299 not in text:
        fail(
            "path leftover-after-299 must keep "
    ...
    path_leftover_299_pins = (
        ...
        (
            "path-filter/path-order residual leftover deepen after " + "#299",
            "path leftover-after-299 wording pin",
        ),
    )
