...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    """Fail-close live stewardship-schema gate wiring (after #72/#75; policy-schema pass-4 after #161; deepen after #53)."""
    ...
    # Fail-closed after #161: policy-schema pass-4 helper / constant / needle pins
    ...
    pass4_doc = "Four" + "th-pass after #161"
    ...
    contract_pass4 = "policy-schema pass-4 after " + "#161"
