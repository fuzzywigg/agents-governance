...
leftover #233 / NOT md/link residual #239 / NOT wiki outline/PUBLISH leftover
#243 / NOT stewardship-badge lint #208):
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    NOT md/link residual #239 / NOT wiki outline/PUBLISH leftover #243 /
...
def check_workflow_hardening_gate_contract(errors: list[str]) -> None:
    ...
    if not_mdlink_239 not in text:
        fail(
            "path residual must keep " + not_mdlink_239 + " distinctness pin",
            errors,
        )
    not_wiki_publish_243 = "NOT wiki outline/PUBLISH leftover " + "#243"
    if not_wiki_publish_243 not in text:
        fail(
            "path residual must keep " + not_wiki_publish_243 + " distinctness pin",
            errors,
        )
