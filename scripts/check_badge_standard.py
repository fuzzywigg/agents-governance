...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    ...
    # (schema residual slice only; not Pass-2 residual templates leftovers #348 /
    ...
    not_pass2_348 = "NOT Pass-2 residual templates leftovers " + "#348"
