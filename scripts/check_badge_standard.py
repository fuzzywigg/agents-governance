...
(NOT schema residual CI #297 / NOT wiki/mdlink leftover residual #293 / NOT stewardship-schema residual #282 /
...
def check_workflow_hardening(errors: list[str]) -> None:
    ...
    Path-filter/path-order residual leftover deepen after #272 (NOT schema residual CI #297 / NOT wiki/mdlink
