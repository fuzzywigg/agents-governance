...
Fail-closed actionlint-style pins (live path after #75; second-pass after #83/#86; third-pass after #104):
...
- Third-pass after #104: concurrency:+cancel-in-progress: / permissions: present /
...
def check_actionlint_style(errors: list[str]) -> None:
    ...
    for name in REQUIRED_WORKFLOWS:
        ...
        # Third-pass after #104: reversible CI concurrency cancel pins.
        ...
        # Third-pass after #104: permissions block must be present (least privilege).
        if "permissions:" not in text:
            fail(f"{name}: actionlint-style requires permissions:", errors)
        # Third-pass after #104: reject extra write scopes on docs CI paths.
...
def check_actionlint_style_gate_contract(errors: list[str]) -> None:
    ...
    third_pass_doc = "Third-pass after " + "#104"
