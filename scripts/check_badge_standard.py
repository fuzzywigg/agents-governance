...
def check_stewardship_schema_gate_contract(errors: list[str]) -> None:
    """Fail-close live stewardship-schema gate wiring (after #72/#75; third-pass after #132; deepen after #165)."""
    ...
    # Fail-closed after #165: schema deepen helper / constant / needle pins
    # (schema leftover slice only; not docs-lint / actionlint / wiki / workflow spam).
    deepen_doc = "Deepen after " + "#165"
    if deepen_doc not in text:
        fail(
