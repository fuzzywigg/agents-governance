...
Fail-closed pins (live path after #48; second-pass after #61; third-pass after #94):
...
def check_badge_standard_gate_contract(errors: list[str]) -> None:
    """Fail-close live badge-standard gate wiring (after #94; deepen after #61; deepen after #48)."""
