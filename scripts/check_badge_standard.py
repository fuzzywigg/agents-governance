...
Fail-closed Pass-2 residual / templates leftover after #309 tip
...
lands closed #313/#312/#305/#298/#291 leftover on post-#309 tip — do not revive #313/#312/#305/#298/#291):
...
def check_lycheeignore(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #309 tip (existing lychee
    ...
    if "tree/main" in text:
        fail(
            ...
            "(Pass-2 residual / templates leftover after #309 tip; "
...
def check_agents_repo_template(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #309 tip (existing
    ...
    for needle, label in leftover_309_required:
        if needle not in text:
            fail(
                f"templates/AGENTS-REPO.md must keep {label} "
                "(Pass-2 residual / templates leftover after #309 tip)",
...
def check_relative_link_gate_contract(errors: list[str]) -> None:
    ...
    if not RUN_STEWARDSHIP.is_file():
        ...
        # Pass-2 residual / templates leftover after #309 tip (soft-fail
...
def check_run_stewardship_gate_contract(errors: list[str]) -> None:
    ...
    # Pass-2 residual / templates leftover after #309 tip contract pins.
    leftover_309 = (
        "Pass-2 residual / templates leftover after " + "#309 tip"
    )
    if leftover_309 not in text:
        fail(
            "run_stewardship pins must keep " + leftover_309 + " marker",
            errors,
        )
