...
- Wiki/mdlink leftover residual after #272 tip (beyond #252 saturated after_243 pins;
  lands closed #281/#277 leftover on post-#278 tip; NOT stewardship-schema leftover residual #282 / NOT lychee/blob-503 leftover #278 /
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #272 tip (beyond #252 saturated pins; lands closed #281/#277 on post-#278 tip; NOT lychee/blob-503 leftover #278).
        yaml_closes_block = (
            "status: ACTIVE\n"
            'created: "2026-09-13"\n'
            'purpose: "Reversible publish path for docs/wiki → GitHub Wiki"\n'
