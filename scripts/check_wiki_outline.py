...
- Wiki/mdlink leftover residual after #299 tip (beyond #293 saturated after_293 pins;
  lands #307/#302 leftover; NOT stewardship-schema residual CI #299 /
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #299 tip (beyond #293 saturated pins; lands #307/#302).
    ...
    if home.is_file():
        ...
        # Wiki/mdlink leftover residual after #299 tip (existing Home.md only; lands #307/#302).
    ...
    if stewardship.is_file():
        ...
        # Wiki/mdlink leftover residual after #299 tip (existing Repo-Stewardship only; lands #307/#302).
