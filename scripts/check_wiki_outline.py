...
- Wiki/mdlink leftover residual after #348 tip (beyond #326 saturated after_326 wiki pins;
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #348 tip (beyond #326 saturated pins;
        # NOT Pass-2 residual / templates leftover #348 /
        # NOT Pass-2 residual / templates leftover #337 /
        # NOT wiki/mdlink leftover residual after #326 /
    ...
    if home.is_file():
        ...
        # Wiki/mdlink leftover residual after #348 tip (existing Home.md only;
        # NOT Pass-2 residual / templates leftover #348 /
        # NOT Pass-2 residual / templates leftover #337 /
        # NOT wiki/mdlink leftover residual after #326 /
        # NOT wiki/mdlink leftover residual after #320 / NOT schema residual CI leftover residual #320).
    ...
    if stewardship.is_file():
        ...
        # Wiki/mdlink leftover residual after #348 tip (existing Repo-Stewardship only;
        # NOT Pass-2 residual / templates leftover #348 /
        # NOT Pass-2 residual / templates leftover #337 /
        # NOT wiki/mdlink leftover residual after #326 /
        # NOT wiki/mdlink leftover residual after #320 / NOT schema residual CI leftover residual #320).
