...
Fail-closed pins (live path after #59; deepen after #43; third-pass after #72):
...
- Third-pass: WIKI exact assign / README+badge hints / downloads+discord+
  twitter+x.com / shields+[![ / Home+PUBLISH+Repo-Stewardship fail strings /
  WIKI.glob+removesuffix / pages+operator OK banner
"""
