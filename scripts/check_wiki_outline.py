...
- Wiki/mdlink leftover residual after #278 tip (beyond #252 saturated after_243 pins;
  lands closed #281/#277 leftover on post-#278 tip; NOT lychee/blob-503 leftover #278 /
  ...
  NOT open stewardship-schema residual after #278;
  existing pages only — do not invent extra wiki files):
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #278 tip (beyond #252 saturated pins; lands #281/#277).
        yaml_closes_block = (
            "status: ACTIVE\n"
            'created: "2026-09-13"\n'
            'purpose: "Reversible publish path for docs/wiki → GitHub Wiki"\n'
