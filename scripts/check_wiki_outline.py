...
- After #117 wiki-badge posture: status badges cover Link Check+Markdown Lint /
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Fail-closed after #117: exact badge-name phrases (wiki-badge posture).
    ...
    if home.is_file():
        ...
        # Fail-closed after #117: Home is narrative — no badge-row embeds.
        if "[![" in home_text:
            fail(
    ...
    if stewardship.is_file():
        ...
        # Fail-closed after #117: wiki-badge posture (Link Check + Markdown Lint only).
    ...
    for name in PUBLISHABLE_PAGES:
        ...
        # Fail-closed after #117: no fourth-badge invent / no badge-row embeds on wiki.
