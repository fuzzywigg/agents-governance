...
- Wiki/mdlink leftover residual after #293 tip (beyond #282/#293 saturated after_282 pins;
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #293 tip (beyond #282/#293 after_282 pins).
    ...
    if home.is_file():
        ...
        # Wiki/mdlink leftover residual after #293 tip (existing Home.md only).
    ...
    if stewardship.is_file():
        ...
        # Wiki/mdlink leftover residual after #293 tip (existing Repo-Stewardship only).
