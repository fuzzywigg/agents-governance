...
- Wiki/mdlink leftover residual after #309 tip (beyond #293 saturated after_293 pins;
  lands #318/#308/#307/#302 leftover (tip-relaunch after #318 DIRTY lint FAIL);
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #309 tip (beyond #293 saturated pins; lands #318/#308/#307/#302).
    ...
    if home.is_file():
        ...
        # Wiki/mdlink leftover residual after #309 tip (existing Home.md only; lands #318/#308/#307/#302).
    ...
    if stewardship.is_file():
        ...
        # Wiki/mdlink leftover residual after #309 tip (existing Repo-Stewardship only; lands #318/#308/#307/#302).
