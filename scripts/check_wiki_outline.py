...
- Wiki/mdlink leftover residual after #297 tip (beyond #293 saturated after_293 pins;
  lands closed #302 leftover; NOT stewardship-schema residual CI #297 /
...
def main() -> int:
    ...
    if publish.is_file():
        ...
        # Wiki/mdlink leftover residual after #297 tip (beyond #293 saturated pins; lands #302).
    ...
    if home.is_file():
        ...
        # Wiki/mdlink leftover residual after #297 tip (existing Home.md only; lands #302).
    ...
    if stewardship.is_file():
        ...
        # Wiki/mdlink leftover residual after #297 tip (existing Repo-Stewardship only; lands #302).
