...
Fail-closed pins (live path after #46 / badge-standard gate):
- FORBIDDEN_BADGE_HINTS deny invent-product / social chrome used by badge + wiki gates
- SECRET_URL_HINTS / SECRET_PATTERNS keep tokens out of public docs
- DANGEROUS_LINK_SCHEMES reject javascript/data/vbscript/file targets
"""
...
def verify_badge_standard_source_contract(errors: list[str]) -> None:
    """Fail-close live badge-standard gate source pins (after #46).
